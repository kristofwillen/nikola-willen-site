...
BLOG_AUTHOR = "Kristof"  # (translatable)
BLOG_TITLE = "Familie Willen"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.willen.be/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/pages/stamboom/", "Stamboom"),
        ("/pages/geografische-verspreiding/", "Geografische verspreiding"),
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS-feed"),
    ),
}
